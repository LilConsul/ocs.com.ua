...
1. **Semantic color tokens** — `bg-primary`, `text-muted-foreground`.
1. **CSS variables** — define custom colors in the global CSS file (see [customization.md](../customization.md)).
