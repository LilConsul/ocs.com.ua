 ...
 *
 * Usage:
 *   bun run i18n:extract              # Extract to .pot and update .po files
 *   bun run i18n:extract -- --init    # Initialize new language .po file
...
function generatePOT(strings) {
	...
	let pot = `# AUTO-GENERATED FILE - DO NOT EDIT MANUALLY
#
# This is the translation template file for OS-Technology Frontend.
# It contains all English source strings extracted from the codebase.
#
# To update this file:
#   Run: bun run i18n:extract
#
# This file is used to generate language-specific .po files.
# Do not edit this file directly - edit the source code instead.
#
# Generation script: scripts/i18n-extract-po.js
# Generated: ${timestamp}+0000
#
...
function updatePO(potStrings, existingPO, language) {
	...
	let po = `# EDIT THIS FILE TO ADD TRANSLATIONS
#
# ${language.toUpperCase()} translations for OS-Technology Frontend.
#
# This file contains translations that are safe to edit.
# Add your ${language.toUpperCase()} translations to the "msgstr" fields below.
#
# To apply your changes:
#   Run: bun run i18n:compile
#
# IMPORTANT: This file is partially auto-generated.
# - The structure (msgid entries) is auto-generated from source code
# - The translations (msgstr values) are manually added and preserved
# - Running "bun run i18n:extract" will add new strings but keep existing translations
#
# Generation script: scripts/i18n-extract-po.js
# Last updated: ${timestamp}+0000
#
# Copyright (C) ${now.getFullYear()} OS-Technology Ukraine
# This file is distributed under the same license as the OS-Technology project.
# FIRST AUTHOR <EMAIL@ADDRESS>, ${now.getFullYear()}.
...
async function extract() {
	...
	console.log(
		"\n[DONE] Extraction complete! Edit .po files to add translations, then run 'bun run i18n:compile'"
	);
}
...
async function initLanguage(lang) {
	if (!existsSync(POT_FILE)) {
		console.error("[ERROR] POT file not found. Run 'bun run i18n:extract' first to generate it.");
		process.exit(1);
	}
...
if (args.includes("--init")) {
	...
	if (!lang) {
		console.error("[ERROR] Usage: bun run i18n:extract -- --init <language>");
		process.exit(1);
	}
	initLanguage(lang);
} else {
